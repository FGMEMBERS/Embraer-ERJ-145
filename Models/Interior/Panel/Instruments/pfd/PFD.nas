...
var canvas_PFD = {
	new: func(canvas_group, instance)
	{
		...
		canvas.parsesvg(canvas_group, "Aircraft/Embraer-ERJ-145/Models/Interior/Panel/Instruments/pfd/pfd.svg", {'font-mapper': font_mapper});
...
var pfdListener = setlistener("sim/signals/fdm-initialized", func () {
	...
	pfd1_display.addPlacement({"node": "PFD.screen"});
